...
namespace Nutmeg {
	...
	public:
		...
		virtual void onStartup(int argc, const char **argv) {
			...
			Log::open("diablo_remix.log");

			platform->setTitle("Diablo Remix");
			...
			game->addEntityLogic <Diablo::EntityEnemy> ("EntityEnemy");
			game->addEntityLogic <Diablo::EntityPlayer> ("EntityPlayer");
			...
			*/
			...
			game->load("../Resource/Diablo/diablo.xml_game");
			game->startLevel(0);
