...
dgConvexSimplexEdge dgCollisionCylinder::m_edgeArray[DG_CYLINDER_SEGMENTS * 2
    * 3];
...
//volume = dgCollisionConvex::CalculateMassProperties (inertia, crossInertia, centerOfMass);
  ...
  inertayyzz = (dgFloat32(0.25f) * m_radius * m_radius
      + dgFloat32(1.0f / 3.0f) * m_height[0] * m_height[0]) * volume;
