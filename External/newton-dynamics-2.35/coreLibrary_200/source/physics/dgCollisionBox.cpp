...
dgCollisionBox::dgCollisionBox(dgMemoryAllocator* allocator,
    ...
    dgFloat32 size_z, const dgMatrix& matrix) :
...
//	volume = dgCollisionConvex::CalculateMassProperties (inertia, crossInertia, centerOfMass);
  ...
  dgFloat32 volume = dgFloat32(8.0f) * m_size[0].m_x * m_size[0].m_y
      * m_size[0].m_z;

  dgVector II(
      dgFloat32(1.0f / 3.0f) * volume
          * (m_size[0].m_y * m_size[0].m_y + m_size[0].m_z * m_size[0].m_z),
      dgFloat32(1.0f / 3.0f) * volume
          * (m_size[0].m_x * m_size[0].m_x + m_size[0].m_z * m_size[0].m_z),
      dgFloat32(1.0f / 3.0f) * volume
          * (m_size[0].m_x * m_size[0].m_x + m_size[0].m_y * m_size[0].m_y),
      dgFloat32(0.0f));
